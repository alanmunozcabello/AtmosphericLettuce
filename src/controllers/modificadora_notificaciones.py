from services.modificadora_service import modificar_html, modificar_pdf
...
def controller_modificar_pdf(correo):
    usuario=controller_obtener_usuario(correo)
    clima=clima_semana_controller(usuario['ubicacion']['latitud'],usuario['ubicacion']['longitud'])
    #queda pendiente la logica de la ia
    consejos=""
    return modificar_pdf(correo,usuario,clima,consejos)  
