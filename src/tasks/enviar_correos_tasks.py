        ...
        if usuarios_data[correo]["notificaciones"]:
            if not len(usuarios_data[correo]["cultivos"]) == 0:
                try:
                        ...
                        if info_cultivo.get("puntos"):
                            ...
                            if primer_punto:
                                ...
                                if clima_cultivo:
                                    ...
                                    print(
                                        f"✅ Clima guardado para "
                                        f"{cultivo_nombre}")

                                    # Usar el primer clima obtenido para el
                                    # HTML
                                    if not clima:
                                        clima = clima_cultivo
                    ...
                    # Si no se pudo obtener clima de cultivos, usar ubicación
                    # del usuario
                    if not clima:
                        clima_response = clima_semana_service(
            ...
            if len(alertas) > 0:
                ...
                for alerta in alertas:
                    ...
                    consejo_texto = (
                        ...
                        f"Se recomienda monitorear de cerca las "
                        f"condiciones y tomar medidas preventivas."
                    )
                    consejos.append({
                ...
                enviar_correos_de_advertencia(
                    correo, usuario, alertas, consejos)
