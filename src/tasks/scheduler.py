...
from tasks.enviar_correos_tasks import enviar_correos_a_todos, verificar_y_enviar_alertas_diarias
...
def start_scheduler():
    ...
    print("💡 Para producción, comenta el bloque de PRUEBA y descomenta PRODUCCIÓN\n")
